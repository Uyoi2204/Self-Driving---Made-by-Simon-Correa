...
//Here we create the "Layers" and the "Weights" of we artificial inteligency
...
public class NNet : MonoBehaviour
{
    ...
    {
        inputLayer[0, 0] = a; //Here we have the 3 Input layer that say the distance of the car to the walls
        inputLayer[0, 1] = b;
        inputLayer[0, 2] = c;
