...
public class CarController : MonoBehaviour
{
    ...
    public float avgSpeedMultiplier = 0.2f; // The weights of the hidden layers change this value
    public float sensorMultiplier = 0.1f;

    [Header("Network Options")]
    public int LAYERS = 1; // We only have 1 hidden layer
    ...
    private float aSensor,bSensor,cSensor; // This sensor give we the information of the distance
    ...
    public void ResetWithNetwork (NNet net) // We reset the information
    {
        network = net;
        Reset();
    }
